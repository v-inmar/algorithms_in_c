...
A simple sorting algorithm that repeatedly steps through the list, compares adjacent elements, and swaps them if they are in the wrong order. The algorithm gets its name because larger elements "bubble" to the end of the list while smaller elements "sink" to the beginning.
